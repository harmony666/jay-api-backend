...
import cn.ichensw.jayapiadmin.config.GatewayConfig;
import cn.ichensw.jayapiadmin.exception.BusinessException;
import cn.ichensw.jayapiadmin.exception.ThrowUtils;
import cn.ichensw.jayapiadmin.service.InterfaceInfoService;
import cn.ichensw.jayapiadmin.service.UserService;
import cn.ichensw.jayapicommon.common.*;
import cn.ichensw.jayapicommon.constant.CommonConstant;
import cn.ichensw.jayapicommon.constant.UserConstant;
import cn.ichensw.jayapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import cn.ichensw.jayapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import cn.ichensw.jayapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import cn.ichensw.jayapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import cn.ichensw.jayapicommon.model.entity.InterfaceInfo;
import cn.ichensw.jayapicommon.model.entity.User;
import cn.ichensw.jayapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        JayApiClient jayApiClient = interfaceInfoService.getJayApiClient(request);
        // 设置网关地址
        jayApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = jayApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = jayApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
